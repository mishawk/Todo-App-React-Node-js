import{r as f,i as L,k as P,l as D,m as _,n as I,o as N,p as R,_ as B,D as A,c as s,a as b,b as l,j as e,G as F,B as T,F as h,u as M,h as j,E as G,C as H,g as O,e as $,f as U}from"./index-38de91d3.js";import{T as W,R as K,u as V}from"./useFilteredPaginatedTodos-f2c775c8.js";import{U as X,u as Y,D as q,t as v,b as z,C as J,a as Q}from"./generateQueryParams-e42faa4b.js";var w=f.forwardRef(function(t,o){var a,d=t.bordered,n=t.className,r=t.compact,g=t.interactive,u=t.striped,x=L(t,["bordered","className","compact","interactive","striped"]),p=P(D,(a={},a[_]=r,a[I]=d,a[N]=u,a[R]=g,a),n);return f.createElement("table",B({},x,{ref:o,className:p}))});w.displayName="".concat(A,".HTMLTable");const Z=s`
	position: absolute;
	top: 50%;
	left: 50%;
